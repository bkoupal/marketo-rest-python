...
class MarketoClient:
    ...
    def _get_export_jobs_list(self, entity):
        ...
        result = self._api_call(
            'get', self.host + '/bulk/v1/{entity}/export.json', args)
        if not result['success']:
            raise MarketoException(result['errors'][0])
        return result['result']
    ...
    def _create_bulk_export_job(self, entity, fields, filters, format='CSV', columnHeaderNames=None):
        ...
        result = self._api_call(
            'post', self.host + '/bulk/v1/{entity}/export/create.json', args, data)
        if not result['success']:
            raise MarketoException(result['errors'][0])
        return result['result']
    ...
    def _export_job_state_machine(self, entity, state, job_id):
        ...
        result = self._api_call(
            state_info[state]['method'], self.host + '/bulk/v1/{entity}/export/{job_id}'+state_info[state]['suffix'], args, mode='nojson')
